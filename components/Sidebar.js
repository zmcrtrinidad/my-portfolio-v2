...
export default function Sidebar() {
  ...
  return (
    ...
    <aside className="fixed z-10 overflow-hidden ">
      ...
      <div
        className="hidden w-auto h-screen p-3 bg-gray-200 lg:bg-transparent lg:items-center lg:flex lg:justify-start lg:p-5 mobile-menu">
        <div className="h-full space-x-1 navbar nav-menu">
          <ul className="flex flex-col justify-center h-screen overflow-y-auto w-52 lg:w-auto ">
            <li>
              <Link href="/#home">
              <a> <i className="fa-solid fa-house"></i>
                <span>Home</span></a>
            ...
            <li>
              <Link href="/#about">
              <a><i className="fa-solid fa-user-astronaut"></i>
                <span>About</span>
              </a>
            ...
            <li>
              <Link href="/#works">
              <a><i className="fa-solid fa-book-open"></i>
                <span>Works</span></a>
            ...
            <li>
              ...
              <a> <i className="fa-solid fa-folder-tree"></i>
            ...
            <li>
              <Link href="/#contact">
              <a><i className="fa-solid fa-address-card"></i>
                <span>Contact</span></a>
